  ...
  const modalHTML = `
    <div class="modal-overlay" id="budgetModal">
      <div class="modal-content" style="position: relative;">
        ...
        <a href="https://wa.me/5581992321938?text=Ol%C3%A1%2C%20gostaria%20de%20solicitar%20um%20or%C3%A7amento" target="_blank" rel="noopener noreferrer" class="btn btn-primary" style="width: 100%; display: flex; align-items: center; justify-content: center; gap: 0.5rem;" onclick="gtag('event', 'conversion', {'send_to': 'AW-18221522730/IjifCPiVl9EcEKq-2fBD'});">
